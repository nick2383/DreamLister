...
//  DreamLister
//
//  Created by Nick Birch on 2017-03-28.
...
//        generateTestData()
    ...
    func attemptFetch() {
        ...
        let tittleSort = NSSortDescriptor(key: "title", ascending: true)
    ...
    func generateTestData() {
        ...
        item.price = 1800
        item.details = "I can't wait until the September event, I hope they realease new MPBs"
